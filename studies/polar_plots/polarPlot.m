function polarPlot(azimutes, rho, values, stitle, slabel)
...
polarplot(theta_vector, r_vector, 'o'); 
hold on;
...
colorbar_handle = colorbar; % Adiciona a barra de cor para a velocidade
